  ...
  const renderSourceLink = (source: string) => {
    ...
    return (
        <button 
          ...
          className="hover:text-indigo-600 hover:underline decoration-indigo-300 underline-offset-2 transition-colors text-left flex items-center gap-1"
        >
            <span>{source}</span>
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 animate-fadeIn">
      ...
      <article className="bg-white rounded-3xl shadow-xl overflow-hidden border border-gray-100">
        {/* Header Image */}
        <div className="relative h-64 md:h-80 bg-indigo-900">
          {loadingImages ? (
             <div className="w-full h-full flex flex-col items-center justify-center bg-indigo-900/50 animate-pulse text-indigo-100">
                ...
                <p className="text-xs font-bold uppercase tracking-wider">Painting Thought...</p>
             </div>
          ...
          <div className="absolute bottom-0 left-0 w-full bg-gradient-to-t from-black/80 to-transparent p-8 z-20">
             <div className="flex gap-2 mb-2">
                <span className="inline-block bg-indigo-500 text-white text-xs font-bold px-2 py-1 rounded uppercase tracking-wide">
                    {item.origin}
                </span>
             </div>
             ...
             <p className="text-indigo-200 text-lg">{item.era}</p>
          </div>
        </div>
        ...
        <div className="p-8 md:p-12 space-y-10">
          ...
          <section className="text-center max-w-2xl mx-auto">
            <h2 className="text-sm font-bold text-gray-400 uppercase tracking-widest mb-3">The Idea</h2>
            <p className="text-2xl md:text-3xl font-serif text-indigo-900 leading-tight italic">
          ...
          <section>
             ...
             <div className="prose prose-lg text-gray-700 leading-loose whitespace-pre-line font-serif">
          ...
          <section className="pt-8 border-t border-gray-100">
             <h2 className="text-xs font-bold text-gray-400 uppercase tracking-widest mb-4">References</h2>
